...
while True:
    ...
    if key == 32:  # space key has a value of 32
        ...
        # Display intermediate steps in new pop-up windows
...
# sql = "INSERT INTO vehicle_plate (s_no, number_p, date) VALUES (%s, %s, %s)"
# val = (text)
        mycursor.execute("INSERT INTO vehicle_plate (number_p) VALUES ('{text}')".format(text=text))
        mydb.commit()
